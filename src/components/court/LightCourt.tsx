...
// Light court (4- or 5-player): beach-derived rotation, so players are shown in
// rotation order in a single row facing the net (the model tracks rotation
// order, not fixed front/back slots). Server = courtPositions[lastRot] is
// highlighted. Rendered on the shared flat court (net across the middle) — §5.
