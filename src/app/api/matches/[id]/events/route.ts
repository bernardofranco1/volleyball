...
const CLIENT_SUBMITTABLE = new Set([
  ...
  "SERVICE_ORDER",
  "RALLY_START", "RALLY_WON_A", "RALLY_WON_B", "REPLAY_POINT", "TIMEOUT_REQUEST", "TIMEOUT_END",
  ...
  "MISCONDUCT_DISQUALIFICATION", "FORFEIT", "SET_DEFAULT", "IMPROPER_REQUEST",
  "ROTATION_FAULT", "SERVICE_ORDER_FAULT", "PROTEST_LODGED", "NOTE", "UNDO",
]);
